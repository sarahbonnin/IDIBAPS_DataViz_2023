...
Starting "/" or "\\" is called the **root** directory. Directories branch downwards from the root directory, and can contain both files and subdirectories.

In the examples above, sbonnin is a subdirectory of users (or Users).

...
* **Data**: that is the source data table that we want to represent.
...
You can access the help page of a function in the **Help** tab in the bottom-right panel. Give it a try with the "geom_point":

<img src="images/ggplot_help" alt="rstudio logo" width="700"/>
...
<img src="images/ggplot_save_parameters.png" alt="import zip" width="500"/>
...
<br>
6. Change the [**theme**](https://ggplot2-book.org/themes):

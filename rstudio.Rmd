...
Let's give it a try. Type (or copy-paste) the following in the console, and hit the **Enter/Return** key:
...
What R returns is the response/result, after computing the content of the code.

The getwd() function outputs your current working directory.
...
In the console, press the **up arrow** key <img src="images/rstudio_up_arrow.png" alt="rstudio interface" width="50"/>: this goes **back to the previous commands** you wrote in the console.

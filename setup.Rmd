...
In the “Packages” box, write “tidyverse” and click “Install”. It should look like the below image:
 ...
 <img src="images/setup_rstudio_install_packages.png" alt="rstudio install packages" width="700"/>
...
Check by copying and pasting the following line of code in the console (bottom-left panel) and click on Enter / Return. You should be able to see the scatter plot appear on the "Plots" tab in the bottom-right panel !
